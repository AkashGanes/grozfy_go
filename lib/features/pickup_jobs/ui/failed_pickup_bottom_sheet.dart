...
/// Shows a bottom sheet asking why the pickup could not be completed.
/// Returns [FailedPickupResult] on confirm, or null if dismissed.
Future<FailedPickupResult?> showFailedPickupSheet(BuildContext context) {
  return showAppBottomSheet<FailedPickupResult>(
    context: context,
    builder: (_) => const _FailedPickupSheet(),
  );
}

class _FailedPickupSheet extends StatefulWidget {
  const _FailedPickupSheet();
...
class _FailedPickupSheetState extends State<_FailedPickupSheet> {
  static const Map<String, String> _reasonOptions = {
    ...
    'customer_refused_to_return': 'Customer Refused to Return Item',
    'wrong_address': 'Wrong Address',
    'item_damaged_by_customer': 'Item Damaged by Customer',
    'pickup_area_unserviceable': 'Pickup Area Unserviceable',
    'other': 'Other',
  };
    ...
    return AppBottomSheet(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Why couldn\'t you complete this pickup?',
            style: TextStyle(
